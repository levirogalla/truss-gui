...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.truss2 = TrussWidget()
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.truss2.sizePolicy().hasHeightForWidth())
        self.truss2.setSizePolicy(sizePolicy)
        self.truss2.setObjectName("truss2")
        self.tabWidget.addTab(self.truss2, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.truss1), _translate("MainWindow", "Truss 1"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.truss2), _translate("MainWindow", "Truss 2"))
