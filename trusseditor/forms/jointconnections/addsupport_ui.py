# Form implementation generated from reading ui file '/Users/levirogalla/Dev/Practice/Projects/truss-gui/trusseditor/forms/jointconnections/addSupport.ui'
#
...
class Ui_AddSupportDialog(object):
    def setupUi(self, AddSupportDialog):
        ...
        AddSupportDialog.setWindowModality(QtCore.Qt.WindowModality.WindowModal)
    ...
    def retranslateUi(self, AddSupportDialog):
        ...
        AddSupportDialog.setWindowTitle(_translate("AddSupportDialog", "Add Support"))
        self.supportType.setItemText(0, _translate("AddSupportDialog", "Fixed Pin"))
        self.supportType.setItemText(1, _translate("AddSupportDialog", "Roller Pin"))
        self.supportType.setItemText(2, _translate("AddSupportDialog", "Fixed"))
