...
class Ui_ColorPicker(object):
    def setupUi(self, ColorPicker):
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.color_vis.sizePolicy().hasHeightForWidth())
        ...
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.color_vis)
        self.lbl_red = QtWidgets.QLabel(parent=self.editfields)
        self.lbl_red.setObjectName("lbl_red")
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.lbl_red)
        ...
        self.formLayout.setWidget(
            4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.lbl_hex)
        ...
        self.formLayout.setWidget(
            4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.hex)
        self.doneButton = QtWidgets.QPushButton(parent=self.editfields)
        self.doneButton.setObjectName("doneButton")
        self.formLayout.setWidget(
            5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.doneButton)
